...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     PhiWheelDist(short);
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("DTTree_zMuSkim_Run2018_fewFiles.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("DTTree_zMuSkim_Run2018_fewFiles.root");
      }
